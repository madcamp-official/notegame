    ...
    public sealed class KeyboardWandererTutorialView : MonoBehaviour
    {
        ...
        private static string[] CreateDefaultPages()
        {
            return new[]
            {
                ...
                "조사: F를 누르고 목표 인물이나 물건을 선택해 실행하세요.\n조사·공격·연결 같은 키보드 기술은 의미 턴 1회와 D20 판정을 사용하며, 성공과 실패가 세계에 남습니다.",
                "WASD를 누르고 있으면 타일을 따라 계속 이동하며, 이동 중 자연스럽게 사건을 만납니다. T를 누르면 언제든 자연어 대화창을 열어 직접 사건이나 행동을 제안할 수 있습니다.\n주요 기술: R은 적 1명 공격, Ctrl A는 주변 적 전체 공격, C는 두 대상 연결·대화, Z는 최근 의미 턴 2개 되돌리기입니다.",
